#!/usr/bin/python3
import os, fcntl,shutil,datetime, logging, sys, os

def print_to_log(object1,object2):
  logging.debug('{} {}'.format(object1,object2))

def set_configuration_file_path():  
  #setup folder path of configuration file
  this_file=os.path.abspath(__file__)
  #print('setting path',this_file)
  parent_folder=os.path.dirname(this_file)
  #print('setting path',parent_folder)
  parent_of_parent_folder=os.path.dirname(parent_folder)
  #print('setting path',parent_of_parent_folder)
  conf_folder=parent_of_parent_folder+'/conf'
  #print ('setting path',conf_folder)
